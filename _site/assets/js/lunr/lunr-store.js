var store = [{
        ...
        "excerpt":"  최근 프로그래머스 과제 테스트에서 고양이 사진 검색 사이트 과제구현을 해보았다. 해당 과제의 내용중에는 다크모드 구현이 있는데 이 때 알게 된 것이 Custom Data Attributes(data-*)이다. 나는 이 기능을 이용하여 data-theme 이라는 속성을 생성하였으며 이를 감지하여 css가 변경되는 코드를 만들어 과제를 해결하였다. data-*   MDN에 data-*은 이렇게 정의 되어 있다. data-* 전역 특성은...","categories": ["css"],
        "tags": ["data-*","css"],
        "url": "/css/Custom-Data-Attributes/",
